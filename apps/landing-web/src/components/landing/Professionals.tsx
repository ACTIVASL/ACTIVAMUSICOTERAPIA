        ...
        <section className="relative bg-white overflow-hidden">
            ...
            <div className="relative z-10 pt-32 pb-16 text-center max-w-4xl mx-auto px-6">
                ...
                <h3 className="text-4xl md:text-5xl lg:text-6xl font-['Outfit'] font-bold text-slate-900 mb-6 leading-tight">
                    ...
                    <span className="text-transparent bg-clip-text bg-gradient-to-r from-slate-900 via-slate-700 to-slate-500">Práctica Profesional</span>
                </h3>
            ...
            <div className="relative py-32 border-t border-gray-100 bg-slate-50" id="software" data-version="titanium-v5-refresh">
                <div className="max-w-[1440px] mx-auto px-6 grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
                    ...
                    <div className="space-y-8">
                        <div className="inline-flex items-center gap-3 px-4 py-2 rounded-full bg-cyan-400/10 border border-cyan-400/20 text-cyan-600">
                            <MonitorPlay size={16} />
                            <span className="text-xs font-bold tracking-widest uppercase">SOFTWARE CLÍNICO CERTIFICADO</span>
                        </div>
                        ...
                        <p className="text-slate-600 font-['Inter'] text-lg leading-relaxed max-w-xl">
                            La herramienta definitiva para validación clínica. Transforma tu metodología con un sistema que integra historia clínica, biofeedback y gestión administrativa en una única plataforma segura y eficiente.
                        </p>
                        ...
                        <div className="flex flex-wrap gap-4 pt-4">
                            <a href="https://activamusicoterapia.com" target="_blank" rel="noopener noreferrer" className="px-8 py-4 bg-gradient-to-r from-cyan-500 to-blue-600 text-white rounded-full font-bold tracking-wide hover:shadow-lg transition-all transform active:scale-95 duration-200 inline-flex items-center justify-center">
                                CONTRATAR LICENCIA (299€)
                            </a>
                            <button onClick={() => onOpenModal?.('lead-magnet', { interest: 'general' })} className="px-8 py-4 border border-slate-300 text-slate-700 rounded-full font-bold tracking-wide hover:bg-white hover:border-slate-400 transition-all flex items-center gap-2 transform active:scale-95 duration-200">
                    ...
                    <div className="relative z-10 w-full lg:h-[800px] flex items-center justify-center perspective-container py-20 lg:py-0">
                        ...
                        <div className="relative w-[90%] lg:w-[800px] aspect-[16/10] bg-white rounded-xl shadow-2xl shadow-slate-200 border-[6px] border-slate-800 ring-1 ring-gray-200 z-10 transition-transform duration-700 hover:scale-[1.01] overflow-hidden group/desktop">
                            ...
                            <div className="w-full h-full bg-slate-100 overflow-hidden relative">
                                <img src={crmDesktop} alt="Panel de Control Clínico CRM Método Activa en Escritorio" className="w-full h-full object-cover object-top bg-white" loading="lazy" decoding="async" />
                            </div>
                            {/* Stand */}
                        ...
                        <div className="absolute -bottom-10 right-0 lg:-right-12 lg:bottom-20 w-[60%] lg:w-[450px] aspect-[4/3] bg-white rounded-[1.5rem] shadow-xl border-[8px] border-slate-800 ring-1 ring-gray-200 z-20 animate-float" style={{ animationDelay: '1s' }}>
                            <div className="w-full h-full bg-slate-100 rounded-2xl overflow-hidden relative group/tablet">
                                <img src={crmTablet} alt="Gestión de Pacientes en Tablet para Terapeutas" className="w-full h-full object-cover object-top bg-white" loading="lazy" />
                            </div>
                            {/* Camera Dot */}
                        ...
                        <div className="absolute -bottom-20 left-4 lg:left-0 lg:bottom-40 w-[35%] lg:w-[240px] aspect-[9/19.5] bg-black rounded-[2.5rem] shadow-xl border-[8px] border-black ring-1 ring-gray-800 z-30 animate-float" style={{ animationDelay: '0s' }}>
                            <div className="w-full h-full bg-white rounded-[2rem] overflow-hidden relative group/mobile">
                                <img src={crmMobile} alt="App Móvil PWA Método Activa para Pacientes" className="w-full h-full object-cover object-top bg-white" loading="lazy" />
                                {/* Dynamic Notch/Bar */}
