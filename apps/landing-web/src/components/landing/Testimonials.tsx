      ...
      <div className="relative z-10 max-w-[1440px] mx-auto px-6 lg:px-12">
        ...
        <RevealSection>
          <div className="text-center mb-20">
            ...
            <h2 className="text-4xl md:text-6xl font-['Outfit'] font-black text-slate-900 leading-tight mb-6 tracking-tighter">
              Historias de <br />
              <span className="text-transparent bg-clip-text bg-gradient-to-r from-[#EC008C] to-cyan-500">
                Vida y Superación
              </span>
            </h2>
            <p className="text-slate-600 text-xl font-['Inter'] font-light leading-relaxed max-w-2xl mx-auto">
              Más de 20 años transformando diagnósticos en melodías de recuperación. La evidencia
              más fuerte son sus voces.
            </p>
          </div>
        </RevealSection>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {[
            {
              quote:
                'Activa ha sido un milagro para la rehabilitación de mi hijo. La música logró conectar con él cuando las palabras ya no llegaban.',
              name: 'María G.',
            ...
            {
              quote:
                'El diplomado me dio las herramientas científicas para llevar mi práctica musical al siguiente nivel clínico. Un antes y un después.',
              name: 'Carlos R.',
            ...
            {
              quote:
                'El software especializado nos permite medir el progreso cognitivo de forma objetiva. Es la pieza que faltaba en la neurorehabilitación.',
              name: 'Dra. Ana L.',
