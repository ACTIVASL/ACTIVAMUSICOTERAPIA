  ...
  const pillars = [
    {
      ...
      description:
        'Intervenciones musicoterapéuticas basadas en evidencia para el tratamiento de trastornos neurológicos y del desarrollo.',
      color: 'text-[#EC008C]',
      glowHex: '#EC008C',
    ...
    },
    {
      ...
      title: 'Academia',
      description:
        'Formación de alto nivel para profesionales de la salud. Masters, cursos y certificaciones internacionales.',
      color: 'text-cyan-400',
      glowHex: '#22d3ee',
    ...
    },
    {
      ...
      description:
        'La primera plataforma CRM especializada en musicoterapia. Gestión clínica, facturación y seguimiento de pacientes.',
      ...
      <div className="max-w-7xl mx-auto px-6 relative z-10">
        ...
        <div className="text-center mb-16 max-w-3xl mx-auto">
          ...
          <p className="text-lg text-slate-400 font-['Inter'] font-light leading-relaxed">
            Unificamos la práctica clínica, la investigación académica y la tecnología en un
            ecosistema diseñado para potenciar el bienestar humano a través de la música y la
            neurociencia.
          </p>
        </div>
