        ...
        <section className="relative py-32 bg-white overflow-hidden" id="clinic">
            ...
            <div className="max-w-7xl mx-auto px-6 relative z-10">
                ...
                <div className="space-y-32">
                    ...
                    <div id="individual" className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-24 items-center group scroll-mt-32">
                        ...
                        <div className="order-1 lg:order-2 space-y-8">
                            ...
                            <div className="space-y-4">
                                ...
                                <div className="flex items-center gap-4 p-4 rounded-2xl bg-slate-50 border border-gray-100 hover:border-[#EC008C]/30 hover:bg-white hover:shadow-lg transition-all">
                                    <NeonIcon icon={MonitorPlay} color="text-[#EC008C]" glowColor="#EC008C" size="sm" bgClass="bg-white border-slate-200" />
                                    <div>
                                ...
                                <div className="flex items-center gap-4 p-4 rounded-2xl bg-slate-50 border border-gray-100 hover:border-[#EC008C]/30 hover:bg-white hover:shadow-lg transition-all">
                                    <NeonIcon icon={MapPin} color="text-[#EC008C]" glowColor="#EC008C" size="sm" bgClass="bg-white border-slate-200" />
                                    <div>
                    ...
                    <div id="grupal" className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-24 items-center group scroll-mt-32">
                        ...
                        <div className="space-y-8 order-1">
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                                <div className="p-6 rounded-2xl bg-slate-50 border border-gray-100 hover:border-cyan-400/50 hover:bg-white hover:shadow-lg transition-all group/card">
                                    <div className="mb-6 flex justify-center">
                                        <NeonIcon icon={Users} color="text-cyan-600" glowColor="#22d3ee" size="md" bgClass="bg-white border-slate-200" />
                                    </div>
                                ...
                                <div className="p-6 rounded-2xl bg-slate-50 border border-gray-100 hover:border-cyan-400/50 hover:bg-white hover:shadow-lg transition-all group/card">
                                    <div className="mb-6 flex justify-center">
                                        <NeonIcon icon={Baby} color="text-cyan-600" glowColor="#22d3ee" size="md" bgClass="bg-white border-slate-200" />
                                    </div>
                            ...
                            {/* GIF Added as Secondary Visual (User Request: "Deja el gif") */}
                            <div className="w-full max-w-sm overflow-hidden rounded-2xl border-4 border-white shadow-2xl shadow-slate-200/50 hover:shadow-slate-300/50 transition-all duration-500 transform hover:scale-[1.02] relative group/gif">
                                <div className="absolute inset-0 bg-gradient-to-t from-slate-900/40 to-transparent pointer-events-none z-10"></div>
                                <img
                                    src={groupSessionGif}
                                    alt="Dinámica de grupo en movimiento"
                                    className="w-full h-48 object-cover"
                                />
                                {/* Label for Premium Feel */}
                                <div className="absolute bottom-3 left-4 z-20 px-3 py-1 bg-white/90 backdrop-blur-md rounded-full border border-white/50 shadow-sm">
                                    <span className="text-[10px] font-['Outfit'] font-bold text-slate-900 uppercase tracking-wider flex items-center gap-1">
                        ...
                        <div className="relative order-2">
                            ...
                            <div className="absolute inset-0 bg-gradient-to-tr from-cyan-200 to-purple-200 rounded-[2.5rem] blur-3xl opacity-30 transform translate-y-6 scale-95 group-hover:scale-100 transition-all duration-700"></div>

                            <div className="relative rounded-[2.5rem] overflow-hidden border-4 border-white shadow-[0_20px_50px_-12px_rgba(0,0,0,0.1)] group-hover:shadow-[0_30px_60px_-12px_rgba(0,0,0,0.15)] transition-all duration-700">
                                <img
                                    src={groupImage}
