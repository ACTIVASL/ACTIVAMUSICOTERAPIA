...
export const About = () => {
  return (
    <section
      id="nosotros"
      className="py-32 px-6 lg:px-12 bg-white border-t border-gray-100 overflow-hidden relative"
    >
      ...
      <div className="max-w-[1440px] mx-auto relative z-10">
        <div className="grid lg:grid-cols-2 gap-20 items-center">
            ...
            <div className="relative w-80 h-96 md:w-[400px] md:h-[500px] mx-auto lg:mx-0">
              ...
              <div className="absolute inset-0 rounded-[2rem] overflow-hidden shadow-2xl shadow-[#EC008C]/10 border border-gray-100 bg-white ring-1 ring-black/5 z-20">
                <div
                  ...
                  role="img"
                  aria-label="Aurora Del Río, Fundadora y Directora Clínica de Activa Musicoterapia"
                ></div>
                ...
                <div className="absolute bottom-0 left-0 w-full p-8 text-white">
                  ...
                  <p className="font-['Inter'] text-sm text-white/80 font-medium tracking-wide border-l-2 border-[#EC008C] pl-3 mt-2">
          ...
          <div className="order-1 lg:order-2">
            <RevealSection>
              <span className="text-[#EC008C] text-xs font-['Outfit'] font-bold tracking-[0.2em] uppercase mb-6 block bg-[#FDF2F8] w-fit px-5 py-2 rounded-full border border-[#EC008C]/10">
                Quiénes Somos
              </span>
              ...
              <div className="space-y-6">
                <p className="text-[#64748B] text-xl font-['Inter'] leading-relaxed font-light">
                  <strong className="text-[#0A0F1D] font-semibold">Activa Musicoterapia</strong> es
                  un servicio de salud y bienestar alternativo diseñado para la recuperación
                  integral de pacientes. A través de nuestra visión, misión y valores, nuestro
                  objetivo principal es conectar de manera significativa con pacientes y cuidadores.
                </p>
                <p className="text-[#64748B] text-xl font-['Inter'] leading-relaxed font-light">
                  Aurora Del Río cuenta con más de 20 años de dedicación a la música y un Máster
                  Europeo de Musicoterapia con calificación de sobresaliente. Junto a su equipo,
                  aplica este conocimiento científico para transformar la salud a través del Método
                  Activa.
                </p>
              </div>
            </RevealSection>
