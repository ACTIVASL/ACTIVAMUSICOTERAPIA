...
import { Menu, X, ChevronDown, UserPlus, Users, Activity, MonitorPlay, GraduationCap, LucideIcon } from 'lucide-react';
    ...
    return (
        ...
        >
            <button className="flex items-center gap-1.5 px-5 py-2 text-sm font-display font-medium text-slate-600 group-hover:text-brand-primary transition-all duration-300 tracking-wide relative z-10">
                {title}
                <ChevronDown className={`w-3.5 h-3.5 transition-transform duration-500 ease-out ${isOpen ? 'rotate-180 text-brand-primary' : 'text-slate-400'}`} />
            ...
            <div className={`absolute top-full left-1/2 -translate-x-1/2 mt-4 w-72 p-2 bg-white/95 backdrop-blur-3xl border border-slate-200/60 rounded-2xl shadow-2xl transition-all duration-300 origin-top overflow-hidden ${isOpen ? 'opacity-100 scale-100 translate-y-0 visible' : 'opacity-0 scale-95 -translate-y-4 invisible'}`}>
...
export const Navigation = () => {
    ...
    return (
        <header>
            <nav
                className="fixed top-0 left-0 right-0 z-[100] bg-slate-50/90 backdrop-blur-xl border-b border-white/40 shadow-sm py-4 transition-all duration-500 ease-in-out"
            >
                    ...
                    <div className="grid grid-cols-2 lg:grid-cols-12 items-center gap-4">
                        ...
                        <div className="hidden lg:flex lg:col-span-6 items-center justify-center h-full">
                            <div className="flex items-center gap-2 px-2 py-1 rounded-full bg-slate-100/50 border border-white/50 shadow-sm backdrop-blur-md">
                                ...
                                <Link to="/blog/beneficios-musicoterapia" viewTransition className="px-5 py-2 text-sm font-display font-medium text-slate-600 hover:text-brand-primary transition-colors relative group">
                                    BLOG
                                ...
                                <a href="#faq" className="px-5 py-2 text-sm font-display font-medium text-slate-600 hover:text-brand-primary transition-colors relative group">
                                    PREGUNTAS
                                    <span className="absolute bottom-1 left-1/2 -translate-x-1/2 w-0 h-[2px] bg-brand-primary group-hover:w-1/2 transition-all duration-300"></span>
                                </a>
                                <a href="#nosotros" className="px-5 py-2 text-sm font-display font-medium text-slate-600 hover:text-brand-primary transition-colors relative group">
                                    NOSOTROS
                                    <span className="absolute bottom-1 left-1/2 -translate-x-1/2 w-0 h-[2px] bg-brand-primary group-hover:w-1/2 transition-all duration-300"></span>
                                </a>
                            </div>
                        ...
                        <div className="px-6 pt-10 pb-12 space-y-8">
                            ...
                            <div className="space-y-8">
                                <div className="space-y-3">
                                    <p className="text-xs font-display font-bold text-brand-primary uppercase tracking-[0.2em] pl-2 border-l-2 border-brand-primary ml-1">Clínica</p>
                                    <a href="#individual" className="block text-2xl font-display font-light text-slate-600 pl-4 hover:text-brand-primary transition-colors">Individual</a>
                                    <a href="#grupal" className="block text-2xl font-display font-light text-slate-600 pl-4 hover:text-brand-primary transition-colors">Grupal</a>
                                </div>
                                <div className="space-y-3">
                                    <p className="text-xs font-display font-bold text-brand-accent uppercase tracking-[0.2em] pl-2 border-l-2 border-brand-accent ml-1">Profesionales</p>

                                    <a href="#software" className="block text-2xl font-display font-light text-slate-600 pl-4 hover:text-brand-primary transition-colors">Software</a>
                                    <a href="#academia" className="block text-2xl font-display font-light text-slate-600 pl-4 hover:text-brand-primary transition-colors">Academia</a>
                                </div>
                                <div className="pt-6 border-t border-slate-200 space-y-4">
                                    <a href="#blog" className="block text-lg font-medium text-slate-500 pl-2 hover:text-brand-primary">Blog</a>
                                    <a href="#faq" className="block text-lg font-medium text-slate-500 pl-2 hover:text-brand-primary">Preguntas</a>
                                    <a href="#nosotros" className="block text-lg font-medium text-slate-500 pl-2 hover:text-brand-primary">Nosotros</a>
                                </div>
                            </div>
                            ...
                            <div className="pt-8 border-t border-slate-200 space-y-4">
                                ...
                                <a href={CRM_URL} className="flex items-center justify-center gap-3 w-full py-4 rounded-xl bg-slate-800 text-white font-bold uppercase tracking-wider shadow-lg border border-slate-700">
