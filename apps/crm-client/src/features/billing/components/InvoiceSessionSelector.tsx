    ...
    return (
        <div className="space-y-6">
            <div className="flex justify-between items-center">
                ...
                <button onClick={onChangeSelection} className="text-xs font-bold text-slate-400 hover:text-slate-600">Cambiar Selección</button>
            </div>
                            ...
                            <div className="flex-1">
                                <p className="font-bold text-slate-800 text-sm">
                                    {mode === 'GROUP' && session.groupName
                                        ? session.groupName
                                        : (session._type === 'individual' ? 'Sesión Individual' : 'Sesión Grupal')}
                                </p>
