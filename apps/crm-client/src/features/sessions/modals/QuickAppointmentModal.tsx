      ...
      if (isRecurring && currentMode === 'existing' && selectedPatientId) {
        ...
        if (futureDates.length > 0) {
          ...
          const sessionsPayload = futureDates.map(futureDate => ({
            ...
            notes: `Sesión recurrente (${recurrenceFreq})`,
            ...
            <div className="bg-slate-50 p-4 rounded-xl border border-slate-100">
              <div className="flex items-center justify-between mb-3">
                <div className="flex items-center gap-2">
                  ...
                  <span className="text-sm font-bold text-slate-700">Repetir Sesión</span>
                </div>
              ...
              {isRecurring && (
                <div className="grid grid-cols-2 gap-3 animate-in fade-in slide-in-from-top-2">
                  ...
                  <div className="col-span-2 text-[10px] text-slate-400 text-center mt-1">
                    Se crearán {recurrenceCount} sesiones adicionales.
                  </div>
                </div>
              )}
            </div>
