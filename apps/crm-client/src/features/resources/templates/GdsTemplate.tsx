          ...
          {[
            ...
            <tr key={i} className="border-b border-slate-200">
              ...
              <td className="p-3 flex gap-4 justify-center">
                <span className="w-8 h-8 border border-slate-300 rounded-full flex items-center justify-center text-xs text-slate-400 uppercase">
                  SÍ
                </span>
                <span className="w-8 h-8 border border-slate-300 rounded-full flex items-center justify-center text-xs text-slate-400 uppercase">
                  NO
      ...
      <div className="mt-8 bg-slate-50 p-6 rounded-xl border border-slate-200 flex justify-between items-center">
        <div>
          ...
          <ul className="text-xs text-slate-500 space-y-1">
            <li>
              <strong>0 - 5:</strong> Normal
            </li>
            <li>
              <strong>6 - 9:</strong> Depresión Probable
            </li>
            <li>
              <strong>10+:</strong> Depresión Establecida
            </li>
          </ul>
        </div>
