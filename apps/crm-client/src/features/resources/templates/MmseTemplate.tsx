      ...
      <div className="space-y-6">
        ...
        <section>
          ...
          <div className="space-y-2 text-sm">
            <div className="flex justify-between border-b border-dotted border-slate-300 pb-1">
              <span>¿En qué año estamos?</span>{' '}
              <span className="w-12 h-6 border border-slate-400"></span>
            </div>
            <div className="flex justify-between border-b border-dotted border-slate-300 pb-1">
              <span>¿En qué estación?</span>{' '}
              <span className="w-12 h-6 border border-slate-400"></span>
            </div>
            <div className="flex justify-between border-b border-dotted border-slate-300 pb-1">
              <span>¿En qué día (número)?</span>{' '}
              <span className="w-12 h-6 border border-slate-400"></span>
            </div>
            <div className="flex justify-between border-b border-dotted border-slate-300 pb-1">
            ...
            <div className="flex justify-between border-b border-dotted border-slate-300 pb-1">
              <span>¿En qué día de la semana?</span>{' '}
              <span className="w-12 h-6 border border-slate-400"></span>
            </div>
            <div className="flex justify-between border-b border-dotted border-slate-300 pb-1 mt-4">
              <span>¿En qué lugar estamos? (Hospital/Centro/Casa)</span>{' '}
              <span className="w-12 h-6 border border-slate-400"></span>
            </div>
            <div className="flex justify-between border-b border-dotted border-slate-300 pb-1">
              <span>¿En qué piso/planta?</span>{' '}
              <span className="w-12 h-6 border border-slate-400"></span>
            </div>
            <div className="flex justify-between border-b border-dotted border-slate-300 pb-1">
              <span>¿En qué pueblo/ciudad?</span>{' '}
              <span className="w-12 h-6 border border-slate-400"></span>
            </div>
            <div className="flex justify-between border-b border-dotted border-slate-300 pb-1">
              <span>¿En qué provincia?</span>{' '}
              <span className="w-12 h-6 border border-slate-400"></span>
            </div>
            <div className="flex justify-between border-b border-dotted border-slate-300 pb-1">
        ...
        <section>
          ...
          <p className="text-sm mb-2 italic">
            Nombrar 3 objetos (ej: PESETA, CABALLO, MANZANA) a 1 seg/palabra. Pedir repetición.
          </p>
        ...
        <section>
          ...
          <p className="text-sm mb-2 italic">
            Si tiene &lt; 3 años escolaridad: Invertir palabra MUNDO (O-D-N-U-M).
          </p>
          <p className="text-sm mb-2 italic">
            Si tiene &gt; 3 años escolaridad: Restar 7 a partir de 100 series (93, 86, 79, 72, 65).
          </p>
          <div className="flex justify-end">
            <span className="w-12 h-8 border border-slate-800 flex items-center justify-center font-bold text-xl">
              /5
        ...
        <section>
          ...
          <p className="text-sm mb-2 italic">
            Repetir los 3 objetos anteriores (PESETA, CABALLO, MANZANA).
          </p>
          <div className="flex justify-end">
            <span className="w-12 h-8 border border-slate-800 flex items-center justify-center font-bold text-xl">
              /3
        ...
        <section>
          ...
          <div className="space-y-2 text-sm">
            <div className="flex justify-between border-b border-dotted border-slate-300 pb-1">
              <span>Denominación (Mostrar Reloj y Lápiz)</span>{' '}
              <span className="w-12 h-6 border border-slate-400"></span>
            </div>
            <div className="flex justify-between border-b border-dotted border-slate-300 pb-1">
              <span>Repetición: "Ni sí, ni no, ni pero"</span>{' '}
              <span className="w-12 h-6 border border-slate-400"></span>
            </div>
            <div className="flex justify-between border-b border-dotted border-slate-300 pb-1">
              <span>Orden 3 Etapas: "Coja papel mano dcha, doble mitad, ponga suelo"</span>{' '}
              <span className="w-12 h-6 border border-slate-400"></span>
            </div>
            <div className="flex justify-between border-b border-dotted border-slate-300 pb-1">
              <span>Lectura y Ejecución: "CIERRE LOS OJOS"</span>{' '}
              <span className="w-12 h-6 border border-slate-400"></span>
            </div>
            <div className="flex justify-between border-b border-dotted border-slate-300 pb-1">
              <span>Escritura: Escribir una frase con sujeto y predicado.</span>{' '}
              <span className="w-12 h-6 border border-slate-400"></span>
            </div>
