  ...
  ({
    ...
    return (
      <button
        ...
        ${isActive ? 'bg-slate-100 text-pink-600 font-bold' : 'text-slate-500 hover:bg-slate-50'}
...
export const Sidebar: React.FC<SidebarProps> = memo(
  ({ currentView, onNavigate, userEmail, isOpen = false, onClose, onLogout }) => {
    ...
    return (
      <>
        ...
        >
          ...
          >
            <div
              className={`flex items-center gap-3 transition-all duration-300 ${collapsed ? 'scale-90' : ''} group cursor-pointer`}
            >
              {/* Logo Logic */}
          ...
          <nav className="flex-1 py-6 space-y-2 px-3 overflow-y-auto custom-scrollbar relative z-10">
            ...
            >
              ...
              {showLabels && (
                <span
                  className={`font-medium text-sm tracking-wide ${currentView === 'dashboard' ? 'font-bold text-slate-900' : 'text-slate-600'}`}
                >
            ...
            <div className="pt-4 pb-2">
              ...
              <SidebarItem
                id="patients"
                icon={Contact}
                label={t('sidebar.nav.patients.all')}
              ...
              <SidebarItem
                id="patients-adults"
                icon={User}
                label={t('sidebar.nav.patients.adults')}
                isActive={currentView === 'patients-adults'}
                isCollapsed={collapsed}
                isMobileOpen={isOpen}
                onClick={handleNavigate}
                onPrefetch={handlePrefetch}
              ...
              <SidebarItem
                id="patients-kids"
                icon={Baby}
                label={t('sidebar.nav.patients.kids')}
                isActive={currentView === 'patients-kids'}
                isCollapsed={collapsed}
                isMobileOpen={isOpen}
                onClick={handleNavigate}
                onPrefetch={handlePrefetch}
            ...
            <div className="pt-2 pb-2">
              ...
              <SidebarItem
                ...
                icon={Users}
                label="Grupal"
                isActive={currentView === 'group-sessions'}
                isCollapsed={collapsed}
                isMobileOpen={isOpen}
                onClick={handleNavigate}
                onPrefetch={handlePrefetch}
            ...
            <div className="pt-2 pb-2">
              ...
              <SidebarItem
                id="resources"
                icon={FileText}
                label={t('sidebar.nav.tools.resources')}
              ...
              <SidebarItem
                id="settings"
                icon={Settings}
                label={t('sidebar.nav.tools.settings')}
          ...
          <div className="p-4 border-t border-slate-200/60 relative z-10">
            <div
              className={`flex items-center gap-3 p-3 rounded-xl bg-slate-50/50 border border-slate-200/50 ${collapsed ? 'md:justify-center md:p-2' : ''}`}
            >
