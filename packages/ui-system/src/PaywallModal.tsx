...
export const PaywallModal = ({ isOpen, onClose, limitType = 'patient', checkoutUrl = 'https://activamusicoterapia.lemonsqueezy.com/checkout/buy/311e8710-d3d8-454c-81f7-200df2a59455' }: PaywallModalProps) => {
                        ...
                        <div className="space-y-4">
                            ...
                            <div className="flex flex-col items-center justify-center gap-2 text-center">
                                <p className="text-xs text-slate-500 font-medium">
                                    <span className="font-bold text-slate-700">IMPORTANTE:</span> El correo que uses en el pago se convertirá automáticamente en tu <span className="font-bold text-pink-600">Llave de Acceso Universal</span>.
                                </p>
